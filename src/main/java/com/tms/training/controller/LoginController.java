...
public class LoginController implements CommunityConstant {
    ...
    public String register(Model model, User user){
        ...
        if(map==null||map.isEmpty()){
            model.addAttribute("msg","注册成功，请前往邮箱继续激活！");
            model.addAttribute("target","/homepage");
...
//        String kaptcha = CommnityUtil.generateUUID();
...
//        }
        ...
        int expiredSeconds = rememberme ? REMEMBER_EXOIRED_SECONDS : DEFAULT_EXPIRED_SECONDS;
